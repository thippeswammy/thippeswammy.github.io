...
```bash
python demo.py --imagedir /home/sdv_edge2/ws_slam/Dataset/09/image_1 --calib /home/sdv_edge2/ws_slam/Dataset/09/calib.txt --viz --plot --save_ply --save_trajectory --save_colmap
```
